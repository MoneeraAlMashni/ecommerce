...
const Header = ({ sharedData, updateSharedData }) => {
        ...
        <div>
            ...
            <header class = "bg-violet-900 ">
                <nav class = " flex h-8 max-w-7xl border-collapse items-center justify-between p-1 " aria-label = "Global">
                    ...
                    <div class = " lg:flex lg:flex-1 lg:justify-end h-8 flex-2  sm:flex">
                        ...
                        <button onClick = {redirectToPage} onChange = {handleClick} class = "text-sm h-8 font-semibold leading-5 text-slate-100 justify-center py-2  lg:border-r-2 pr-5 border-violet-950 ">

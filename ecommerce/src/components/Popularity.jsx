    ...
    return (
        <div className="mt-20 px-10 " >
            ...
            <div className='flex justify-between w-20 '>
                ...
                <button className='border-b-2 ml-0 text-left float-left pb-2 lg:w-15 w-30 pl-6 '>
            ...
            <div className=" lg:w-60  overflow-y-scroll h-80 mr-3 ">

                {products && products.map(event => (
